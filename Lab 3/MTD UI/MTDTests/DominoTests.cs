...
namespace MTDTests
{
    ...
    public class DominoTests
    {
        ...
        {
            Domino d = new Domino();
            Assert.Throws<ArgumentOutOfRangeException>(() => d.Side1 = -1);
            Assert.Throws<ArgumentOutOfRangeException>(() => d.Side1 = 15);
            Assert.AreEqual(0, d.Side1);
            Assert.AreEqual(0, d.Side2);
        }
        ...
        [Test]
        public void TestToString() => Assert.True(d12.ToString() == "[1, 2]");
    }
}
